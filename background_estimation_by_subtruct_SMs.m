...
%%
fileName1 = [[fileFolder,'processes data\BKG_list_data119_123\data'],  num2str(ID(kk)) '_xch.csv'];
...
fileName1 = [[fileFolder,'processes data\BKG_list_data119_123\data'],  num2str(ID(kk)) '_ych.csv'];
data = readtable(fileName1);
